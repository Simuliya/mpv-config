...
local timeout = 15
local key_unbound = false -- 添加标志变量
...
function M.resume_count_down()
    ...
    -- 输出调试信息
    msg.info('Restored jump_file: ' .. (jump_file or 'nil'))
    msg.info('Current file: ' .. mp.get_property('filename'))
    
    -- 检查 jump_file 是否为空或与当前文件名相同
