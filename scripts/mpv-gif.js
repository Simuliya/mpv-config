...
var levelDict = parseMsgLevel(
  msg_level !== null && msg_level !== void 0 ? msg_level : ""
);
...
function getLogLevel(moduleName) {
  ...
  return (_a =
    levelDict === null || levelDict === void 0
      ? void 0
      : levelDict[moduleName]) !== null && _a !== void 0
    ? _a
    : DEFAULT_LEVEL;
}
/**
...
(function (mp) {
  ...
  function initEnvOptions() {
    envOptions.filename = mp.get_property("path") || "";
  ...
  mp.add_key_binding("g", "setStartTime", function setStartTime() {
